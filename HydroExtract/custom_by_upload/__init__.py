...
if __name__ == '__main__':
    workspace = '/usr/local/large_scale_hydro/Figure/5.2'
    dem_tif_path = '/usr/local/large_scale_hydro/Figure/5.2/data/dem.tif'
    lakes_shp_path = '/usr/local/large_scale_hydro/Figure/5.2/data/lakes_shp.shp'
    river_threshold = 500
